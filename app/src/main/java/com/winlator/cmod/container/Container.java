...
public class Container {
    ...
    public static final String DEFAULT_GRAPHICSDRIVERCONFIG =
            "vulkanVersion=1.3" + ";version=" + ";blacklistedExtensions=" + ";maxDeviceMemory=0" + ";presentMode=mailbox" + ";syncFrame=0" + ";disablePresentWait=0" + ";astcTranscode=1" + ";etc2Transcode=0" + ";resourceType=auto" + ";bcnEmulation=auto" + ";bcnEmulationType=compute" + ";bcnEmulationCache=0" + ";gpuName=Device";
    ...
    public UnifiedInputState.EmulationMode getEmulationMode() {
        return emulationMode;
    }

    public void setEmulationMode(UnifiedInputState.EmulationMode emulationMode) {
        ...
        for (Iterator<String> it = data.keys(); it.hasNext(); ) {
            ...
            switch (key) {
                ...
                case "exclusiveXInput" :
                    ...
                    break;
            case "emulationMode" :
                String modeName = data.getString(key);
                try {
                    setEmulationMode(UnifiedInputState.EmulationMode.valueOf(modeName));
