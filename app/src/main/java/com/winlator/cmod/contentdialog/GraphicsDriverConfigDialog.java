...
public class GraphicsDriverConfigDialog extends ContentDialog {
    ...
    private String selectedVulkanVersion;
    private String selectedVersion;
    private String blacklistedExtensions = "";
    private String selectedGPUName;
    private String selectedDeviceMemory;

    private String isSyncFrame;
    private String isDisablePresentWait;
    private String selectedPresentMode;
    ...
    public String writeGraphicsDriverConfig() {
        config.put("vulkanVersion", selectedVulkanVersion);
        config.put("version", selectedVersion);
        config.put("blacklistedExtensions", blacklistedExtensions);
        config.put("maxDeviceMemory", String.valueOf(StringUtils.parseNumber(selectedDeviceMemory)));
        config.put("presentMode", selectedPresentMode);
        config.put("syncFrame", isSyncFrame);
        config.put("disablePresentWait", isDisablePresentWait);
        config.put("resourceType", selectedResourceType);
        config.put("gpuName", selectedGPUName);

        String graphicsDriverConfig = toGraphicsDriverConfig(config);
    ...
    private void initializeDialog(View anchor, String graphicsDriver, TextView graphicsDriverVersionView) {
        ...
        populateGraphicsDriverVersions(anchor.getContext(), contentsManager, vulkanVersion, initialVersion, blExtensions, gpuName, maxDeviceMemory, presentMode, resourceType, graphicsDriver);
    ...
    private void populateGraphicsDriverVersions(Context context, ContentsManager contentsManager, String vulkanVersion, @Nullable String initialVersion, @Nullable String blExtensions, String gpuName, String maxDeviceMemory, String presentMode, String selectedResourceType, String graphicsDriver) {
